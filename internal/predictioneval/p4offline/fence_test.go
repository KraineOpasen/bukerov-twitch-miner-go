...
// THE WITNESS/WIDTH CENSUS LIVES IN evidence_internal_test.go, not here, although
// it is a fence in the same sense as the rules above. It walks for UNEXPORTED
// fields and binds itself to a helper that drives them, so it has to be in the
