...
- Use `{baseDir}/adversarial.md` for the full adversarial methodology with examples
- Use `{baseDir}/patterns.md` for common vulnerability pattern reference
- Use `{baseDir}/methodology.md` for the broader review workflow context
<!-- /bukerov-local-patch: tob-plugin-agents-relocated -->
