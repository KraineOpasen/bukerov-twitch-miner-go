...
<!-- bukerov-local-patch: tob-dead-pointer — removed the "Domain-Specific:" bullets (domain-specific-audits/defi-bridges, /tick-math, /merkle-trees, /skills); none of them exist in this install -->

**Solidity-Specific:**
<!-- bukerov-local-patch: tob-dead-pointer — removed the `not-so-smart-contracts` and `token-integration-analyzer` bullets; neither exists in this install -->
