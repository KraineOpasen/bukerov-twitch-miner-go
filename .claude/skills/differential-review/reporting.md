...
```
<!-- bukerov-local-patch: tob-dead-pointer — removed the "chain with issue-writer" next-step line above and the whole "Integration with issue-writer" section that followed; no `issue-writer` skill exists in this install -->
