...
<!-- bukerov-local-patch: writing-for-agents-user-invoked -->
Explicit-invocation-only in this vendored copy: reference material only, consulted by request. It grants no
standing authority to edit this project's `CLAUDE.md`, `AGENTS.md`, `.claude/rules/**`, hooks, settings, or any
tracked file — any such edit still requires the active task contract to authorize it.
<!-- /bukerov-local-patch: writing-for-agents-user-invoked -->
