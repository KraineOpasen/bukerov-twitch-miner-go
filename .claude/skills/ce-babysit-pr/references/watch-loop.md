...
- **PR closed or merged externally:** detected as `pr_state != "OPEN"` on any tick → clean exit with a final status.<!-- bukerov-local-patch: ce-no-merge-authority — deleted the just-landed `stack-land` exception. -->
