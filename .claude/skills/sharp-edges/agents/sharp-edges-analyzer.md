...
<!-- bukerov-local-patch: tob-plugin-agents-relocated -->
- **Cryptographic APIs**: `{baseDir}/references/crypto-apis.md`
- **Configuration Patterns**: `{baseDir}/references/config-patterns.md`
- **Authentication/Session**: `{baseDir}/references/auth-patterns.md`
- **Case Studies**: `{baseDir}/references/case-studies.md`

Language-specific footgun guides:

| Language | Reference |
|----------|-----------|
| C/C++ | `{baseDir}/references/lang-c.md` |
| Go | `{baseDir}/references/lang-go.md` |
| Rust | `{baseDir}/references/lang-rust.md` |
| Swift | `{baseDir}/references/lang-swift.md` |
| Java | `{baseDir}/references/lang-java.md` |
| Kotlin | `{baseDir}/references/lang-kotlin.md` |
| C# | `{baseDir}/references/lang-csharp.md` |
| PHP | `{baseDir}/references/lang-php.md` |
| JavaScript/TypeScript | `{baseDir}/references/lang-javascript.md` |
| Python | `{baseDir}/references/lang-python.md` |
| Ruby | `{baseDir}/references/lang-ruby.md` |

For a combined quick reference across all languages, see `{baseDir}/references/language-specific.md`.
<!-- /bukerov-local-patch: tob-plugin-agents-relocated -->
