...
<!-- bukerov-local-patch: tob-no-hidden-unicode — the family-emoji literal below spells its three U+200D joiners as Swift `\u{200D}` escapes; the raw joiners failed the repo hidden-unicode check -->
...
let emoji = "👨\u{200D}👩\u{200D}👧\u{200D}👦"  // Family emoji
