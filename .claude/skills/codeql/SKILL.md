...
There is no plugin slash command in this project-local install — work
[build-database.md](workflows/build-database.md) by hand, walking the method ladder and applying
fixes from [build-fixes.md](references/build-fixes.md) between rungs, then enforce the quality gate.
<!-- /bukerov-local-patch: tob-no-plugin-workflow -->
